    ...
    <article className={picked ? "live-match-card picked" : "live-match-card"}>
      <button className="live-match-row" type="button" aria-expanded={expanded} onClick={onToggle}>
        ...
        <span className="match-impact">
          <small>{fixture.thirdPlace ? "3rd place" : groupOrStageLabel(fixture)}</small>
      ...
      {expanded ? (
        <div className="match-entrant-panel">
          {fixture.thirdPlace ? (
            <p className="goals-only-note">Third-place playoff. The result and goals count, but there's no bonus for reaching the final.</p>
          ) : null}
