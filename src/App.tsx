...
import { buildScoresFromFixtures, fetchWorldCupFixtures, getCorrectPredictionFromScores, getCurrentFixtures, isFixtureInKickoffWindow, isThirdPlacePlayoffEvent, THIRD_PLACE_MATCH_IDS } from "./lib/worldCupApi";
  ...
  return rows
    .map((row) => {
      ...
      return {
        ...
        thirdPlace: THIRD_PLACE_MATCH_IDS.has(row.espn_match_id) || isThirdPlacePlayoffEvent(row.raw_payload ?? {}),
